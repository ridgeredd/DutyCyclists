...
// RIDGE NOTE: redefine packet length
// RIDGE NOTE 2: no don't do this, we'll check packet length in our decode to catch if it was invalid noise
 ...
 */
	...
	// RIDGE NOTE
	// This is where the byte data stream has been found
 ...
 */
	    ...
	    if (H2.olen & 8) {
		  ...
		  // RIDGE NOTE:
		  // This is where the frames are placed as bytes
 ...
 */
	...
	if (H2.olen == 0 && H2.frame_len >= MIN_FRAME_LEN) {
	  ...
	  // RIDGE NOTE: this is CRC for error detection
